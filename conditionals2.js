...
if (broj1 === broj2){console.log (3*(broj1+broj2))}
else console.log (broj1 + broj2);
...
var broj3 = 50
var broj4 = 50
if (broj3 + broj4 === 50 || broj3 === 50 || broj4 === 50) {console.log ('true')}
else console.log ('-');
...
var nekibroj = 500
if (nekibroj > 20 && nekibroj <100){console.log ("20 ↔ 100")}
if (nekibroj >= 100 && nekibroj <= 400){console.log("100 ↔ 400")}
if (nekibroj < 20 || nekibroj > 400) {console.log('-')}
